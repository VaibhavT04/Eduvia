...
function MaterialCardItem({item, studyTypeContent, course, refreshData}) {
  ...
  const hasContent = () => {
    ...
    switch (item.name) {
      ...
      case 'Flashcard':
        return studyTypeContent.flashcards && studyTypeContent.flashcards.length > 0;
      case 'Quiz':
        return studyTypeContent.quiz && studyTypeContent.quiz.length > 0;
      case 'Question/Answer':
        return studyTypeContent.qa && studyTypeContent.qa.length > 0;
      default:
        return false;
    }
  };
